...
const ClinicLayout = ({ children }) => {
  ...
  return (
    <div className="clinic-dashboard d-flex bg-color min-vh-100 position-relative">
        ...
        <div>
          ...
          <ul className="nav flex-column gap-2 mb-4 text-start">
            ...
            <li className="nav-item">
              ...
              >
                <i className="bi bi-patch-question"></i> New Questions
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink 
                ...
                className={({ isActive }) => `nav-link w-100 rounded-16 py-3 px-4 border-0 text-start d-flex align-items-center gap-3 ${isActive ? 'bg-primary-green text-white fw-semibold' : 'text-white-50 bg-transparent'}`}
              >
                <i className="bi bi-file-earmark-medical"></i> Question History
              </NavLink>
            </li>
            ...
            <li className="nav-item">
              <NavLink 
                ...
                className={({ isActive }) => `nav-link w-100 rounded-16 py-3 px-4 border-0 text-start d-flex align-items-center gap-3 ${isActive ? 'bg-primary-green text-white fw-semibold' : 'text-white-50 bg-transparent'}`}
              >
                <i className="bi bi-building"></i> Clinic Profile
              </NavLink>
            </li>
            <li className="nav-item">
              <button className="nav-link w-100 text-white-50 bg-transparent py-2 px-3 rounded-12 d-flex align-items-center gap-3 hover-bg text-start border-0">
          ...
          <div className="d-flex align-items-center gap-4">
            ...
            <div className="d-flex align-items-center gap-3 border-start ps-4">
              <div className="text-end d-none d-sm-block">
                <h4 className="h6 fw-bold text-dark mb-0">Happy Paws Clinic</h4>
                <span className="text-muted small" style={{ fontSize: '0.75rem' }}>Pet Clinic</span>
              </div>
              <img src={heroPets} alt="Clinic Avatar" className="rounded-circle" style={{ width: '40px', height: '40px', objectFit: 'cover' }} />
